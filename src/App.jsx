...
const TEMPLATES=[
  ...
  // ═══ KOL风格模板（模拟分析50条真实视频提炼） ═══
  {id:1,name:"美妆种草闺蜜风",category:"KOL风格",plat:"抖音",desc:"像闺蜜分享好物一样的真实种草，痛点驱动+亲测背书",badges:[{t:"完播率 +28%",c:"conv"},{t:"高转化",c:"auth"}],tags:["美妆护肤","种草带货"],stat:"+28%",uses:"基于50+美妆博主视频提炼",
    style_summary:"亲密闺蜜式分享，语气真诚不做作，先暴露自己的问题再推荐解决方案，像是姐妹私聊",personality:"25-30岁都市女性，护肤经验丰富但不端着，偶尔自嘲，爱用夸张语气词",emotion_tone:"轻松→焦虑→惊喜→感动，情绪波动大但不刻意",formula:"自曝痛点→踩坑经历→偶然发现→亲测效果→闺蜜安利",hook_strategy:"用极端痛点场景开头，如'凌晨3点照镜子差点吓哭自己'",conflict_setup:"先展示自己最差的状态，让观众产生'我也是这样'的共鸣",trust_mechanism:"展示真实使用过程+前后对比+周围人的反馈（同事、男朋友的惊讶反应）",price_anchor:"对标医美/大牌价格，突出性价比，'做一次水光针几千块，这个一盒才XX'",urgency_tactic:"'我先囤了三盒''链接随时下架''这个价格不知道还能撑多久'",emotion_curve:"好奇(8)→焦虑(9)→转折(6)→惊喜(10)→信任(9)→行动(8)",pacing:"前3秒快节奏抓人→中段放慢展示质地→结尾加速逼单",keyword_bank:["救命","绝了","你敢信","闺蜜偷偷告诉我","我先囤了","不买也收藏","一整个爱住","回购无数次"],power_words:["亲妈级","断货王","熬夜急救","闺蜜推荐","平价替代"],sentence_patterns:["你看这个XX...【重】绝了！","我跟你说...XX真的救了我的命","用了一周...XX问我是不是去打了XX","反正我是已经囤了...链接放这儿了"],sample_hooks:["凌晨3点照镜子...差点没认出自己","这3000块的智商税，今天全告诉你","被我闺蜜安利了一个月，终于忍不住试了"],dos:["语气要像和闺蜜聊天","必须有真实使用感受描述","结尾用'我先囤了'而不是'赶紧买'"],donts:["不要用专业术语","不要像广告一样硬推","不要过度美化效果"]},
  {id:2,name:"科技测评理性派",category:"KOL风格",plat:"抖音",desc:"参数硬核+幽默吐槽+对比实测，适合3C数码家电",badges:[{t:"完播率 +22%",c:"conv"},{t:"专业权威",c:"auth"}],tags:["数码3C","家电"],stat:"+22%",uses:"基于50+科技博主视频提炼",
    style_summary:"理性中带幽默，用数据说话但不枯燥，喜欢做A/B对比实验，偶尔吐槽行业乱象",personality:"30-35岁理工男，技术功底扎实，说话直来直去，不吹不黑",emotion_tone:"冷静→好奇→震惊→认可，情绪克制但在关键数据处爆发",formula:"行业痛点/常见误区→参数对比→实测数据→使用体验→购买建议",hook_strategy:"用反常识观点开头，如'XX品牌标价3000的东西，成本可能不到200'",conflict_setup:"揭露行业潜规则或消费者常见误区，建立'我帮你避坑'的信任",trust_mechanism:"实测数据+参数横评+拆机展示+第三方检测报告引用",price_anchor:"同配置/同功能产品价格横向对比，突出性能价格比",urgency_tactic:"'这个价格窗口期不会太长''上次推荐完一周就涨价了'",emotion_curve:"好奇(7)→专注(8)→震惊(9)→认可(10)→行动(7)",pacing:"全程中速节奏，数据展示处放慢，结论处加速",keyword_bank:["实测","跑分","拆机","横评","性价比","智商税","真香","翻车"],power_words:["实测数据","碾压","吊打","真香机","性能怪兽"],sentence_patterns:["先看参数...XX比XX高了XX%","很多人不知道...其实XX的核心是XX","实测结果出来了...说实话我自己都没想到","这个价位...【重】直接闭眼入"],sample_hooks:["花了5000块买了同品类Top5，实测结果让我震惊","你以为的XX和真正的XX，差距有多大？","厂商不会告诉你的秘密..."],dos:["必须有数据支撑","对比要公平客观","结论要明确不含糊"],donts:["不要只说优点不说缺点","不要用花哨滤镜","不要过度渲染情绪"]},
  {id:3,name:"乡村生活沉浸流",category:"KOL风格",plat:"抖音",desc:"快节奏生活化叙事+场景沉浸+软植入，适合食品农产品",badges:[{t:"完播率 +35%",c:"exp"},{t:"自然种草",c:"exp"}],tags:["三农食品","生活方式"],stat:"+35%",uses:"基于50+乡村/生活博主视频提炼",
    style_summary:"沉浸式生活纪录片风格，产品自然融入日常场景，不说教不推销，让画面说话",personality:"朴实真诚的生活记录者，热爱生活，用行动代替语言",emotion_tone:"宁静→温暖→食欲→满足，全程正向情绪缓慢递进",formula:"日常场景→自然使用→过程展示→成果呈现→轻微引导",hook_strategy:"用极具画面感的生活场景开头，如清晨露水、炊烟升起",conflict_setup:"不刻意制造冲突，用生活中的小确幸和仪式感吸引人",trust_mechanism:"全程无台词硬推，纯靠画面质感和真实场景建立信任",price_anchor:"强调原产地、手工制作、天然无添加等价值感",urgency_tactic:"'应季限定''今年产量有限''错过等明年'",emotion_curve:"宁静(5)→温暖(7)→满足(9)→向往(8)→行动(6)",pacing:"整体慢节奏，快切镜头堆叠生活细节，ASMR式音效",keyword_bank:["应季","手工","自然","原产地","小时候的味道","妈妈的味道","限量","纯天然"],power_words:["产地直发","纯手工","零添加","应季鲜货","老味道"],sentence_patterns:["（几乎无台词，靠字幕和画面）","清晨XX点...XX（场景描述）","这是今年第一批XX...","喜欢的朋友...链接在XX"],sample_hooks:["（清晨炊烟升起的画面，配轻音乐）","（阳光穿过树叶洒在XX上的特写）","（双手捧起新鲜XX，水珠滚落的慢镜头）"],dos:["画面质感要像电影","产品要自然融入场景","配乐要舒服不刺耳"],donts:["不要硬推产品","不要过多台词","不要城市化的拍摄风格"]},
  {id:4,name:"知识科普专家型",category:"KOL风格",plat:"抖音",desc:"翻译专业术语成人话，成分党/原理党最爱",badges:[{t:"完播率 +30%",c:"exp"},{t:"专业信任",c:"auth"}],tags:["美妆成分","健康养生"],stat:"+30%",uses:"基于50+知识科普博主视频提炼",
    style_summary:"把专业知识翻译成大白话，用实验和可视化让枯燥知识变有趣，观众看完有'涨知识了'的满足感",personality:"学霸人设，专业但不枯燥，喜欢用类比和实验让人秒懂",emotion_tone:"好奇→恍然大悟→震惊→信服，知识获取带来的爽感",formula:"常见误区/问题→科学解释→实验验证→产品关联→总结建议",hook_strategy:"用反常识知识点开头，如'你每天都在用的XX，其实一直用错了'",conflict_setup:"指出大众的认知误区，制造'我居然一直搞错了'的冲击",trust_mechanism:"引用论文数据+可视化实验+成分解析+专业背景",price_anchor:"从成分和功效角度解释价格合理性，'光这一个成分的含量就值XX'",urgency_tactic:"'配方随时可能调整''这个浓度的XX市面上很少见'",emotion_curve:"好奇(8)→专注(9)→恍悟(10)→信服(9)→行动(7)",pacing:"前3秒快问快答→中段讲解适中→实验处放慢→结论加速",keyword_bank:["成分党","配料表","翻译成人话","科学证实","临床数据","有效浓度","智商税","真正有用的"],power_words:["有效成分","临床验证","黄金浓度","核心科技","专利配方"],sentence_patterns:["很多人不知道...XX的关键其实是XX","我把配料表翻译成人话...第一个XX，作用是XX","实验结果出来了...【重】差距真的太明显了","总结一下...真正值得买的就XX点"],sample_hooks:["你每天涂的XX，90%的人都用错了","配料表第一行就是智商税，教你三秒识别","我在实验室测了10款XX，结果让我大吃一惊"],dos:["知识点要准确可查证","用类比让人秒懂","实验过程要可视化"],donts:["不要堆砌专业术语","不要念论文","不要夸大功效"]},
  {id:5,name:"直播切片逼单型",category:"KOL风格",plat:"抖音",desc:"紧迫感+价格战+库存焦虑，直播电商高转化话术",badges:[{t:"完播率 +25%",c:"conv"},{t:"强逼单",c:"conv"}],tags:["电商直播","高转化"],stat:"+25%",uses:"基于50+直播切片视频提炼",
    style_summary:"高能量快节奏，持续制造紧迫感和稀缺感，用价格对比和限时限量刺激即时购买",personality:"自信有气场的主播人设，说话掷地有声，节奏感强",emotion_tone:"震惊→兴奋→紧张→冲动，全程高能不给思考时间",formula:"价格锚定→产品展示→限时优惠→库存告急→催促下单",hook_strategy:"直接用价格冲击开头，'原价XX的东西，今天只要XX'",conflict_setup:"用原价vs活动价的巨大落差制造冲击",trust_mechanism:"现场展示+销量数据+品牌授权+限时限量",price_anchor:"先报原价/专柜价→再报活动价→最后加赠品，层层递进",urgency_tactic:"'库存只剩XX单''倒计时开始''今天过了就恢复原价'",emotion_curve:"震惊(9)→兴奋(10)→紧张(9)→冲动(10)→行动(10)",pacing:"全程快节奏，几乎不给观众喘息时间",keyword_bank:["家人们","不要XX块","今天只要","库存告急","最后XX单","拍1发3","史上最低","再不抢就没了"],power_words:["骨折价","买一送一","限时秒杀","仅此一天","全网最低"],sentence_patterns:["家人们看好了！这个XX原价XX...今天！只要XX！","不要犹豫！库存只剩XX单了！","买到就是赚到...这个价格我自己都心动","3-2-1上链接！手慢无！"],sample_hooks:["原价899的XX，今天直播间只要多少钱？来！99！","家人们我求品牌给的价格...你们猜多少？","这个东西我自己都囤了5箱..."],dos:["节奏要快","价格对比要清晰","紧迫感要持续"],donts:["不要拖泥带水","不要理性分析太多","不要给观众犹豫时间"]},
  // ═══ 营销方法论模板 ═══
  {id:6,name:"PAS痛点放大法",category:"营销方法论",plat:"通用",desc:"Problem痛点→Agitate放大→Solution解决，经典高转化公式",badges:[{t:"完播率 +22%",c:"conv"},{t:"经典模型",c:"auth"}],tags:["通用","转化型"],stat:"+22%",uses:"经典营销方法论",
    style_summary:"先精准戳中痛点，再放大焦虑让用户坐不住，最后递上解决方案。情绪先抑后扬，转化率极高",personality:"理解用户痛苦的知心人，先共情再提供方案",emotion_tone:"共鸣→焦虑→释放→满足",formula:"Problem(精准痛点)→Agitate(放大后果)→Solution(完美解决)",hook_strategy:"用最具体、最扎心的痛点场景开头",conflict_setup:"不只是指出问题，还要放大'不解决会怎样'的后果",trust_mechanism:"用案例和数据证明方案确实有效",price_anchor:"解决这个痛点的价值远大于产品价格",urgency_tactic:"'这个问题越拖越严重''现在解决还来得及'",emotion_curve:"共鸣(8)→焦虑(10)→希望(6)→满足(9)→行动(8)",pacing:"痛点处慢放，放大焦虑时加速，解决方案处适中",keyword_bank:["你是不是也","受够了","终于","原来","其实很简单","一招搞定"],power_words:["根治","从根源解决","告别","不再","彻底"],sentence_patterns:["你是不是也XX？...其实不是你的问题，是XX","如果再不XX...后果你想都不敢想","别急...我找到了一个方法，XX就能解决"],sample_hooks:["每次XX都想哭？不是你不行，是方法错了","90%的人都在犯这个错...越XX越严重"],dos:["痛点要具体不要泛泛","焦虑放大要有度","解决方案要简单明确"],donts:["不要制造虚假恐慌","不要过度贩卖焦虑","解决方案不要太复杂"]},
  {id:7,name:"AIDA注意力漏斗",category:"营销方法论",plat:"通用",desc:"Attention→Interest→Desire→Action，注意力到行动的完整链路",badges:[{t:"完播率 +24%",c:"conv"},{t:"经典模型",c:"auth"}],tags:["通用","品牌型"],stat:"+24%",uses:"经典营销方法论",
    style_summary:"层层递进，从抓注意力到激发兴趣到制造欲望到促成行动，每一步都有明确目的",personality:"有策略感的品牌讲述者",emotion_tone:"惊讶→好奇→渴望→冲动",formula:"Attention(抓眼球)→Interest(引兴趣)→Desire(激欲望)→Action(促行动)",hook_strategy:"用最反常识或最震撼的画面/信息抓注意力",conflict_setup:"在Interest阶段制造'我也想要'的心理",trust_mechanism:"用户证言+效果展示+权威背书",price_anchor:"在Desire阶段展示产品带来的生活改变，让价格不再是障碍",urgency_tactic:"在Action阶段制造立即行动的理由",emotion_curve:"注意(9)→兴趣(7)→欲望(10)→行动(8)",pacing:"A快→I中→D慢（让欲望发酵）→A快",keyword_bank:["你见过XX吗","想象一下","如果告诉你","现在就可以","点击下方"],power_words:["颠覆","重新定义","从未见过","立即拥有"],sentence_patterns:["你见过XX的XX吗？...没有吧，因为XX","想象一下...每天只需XX分钟，就能XX","现在...只需XX步，你也可以XX"],sample_hooks:["这可能是你今年看到的最XX的东西","如果我告诉你...XX只需要XX秒？"],dos:["每个阶段目的要明确","过渡要自然","行动指令要清晰"],donts:["不要跳步骤","不要在A阶段就开始推销","D阶段不要理性分析破坏欲望"]},
  {id:8,name:"剧情反转炸弹",category:"营销方法论",plat:"抖音",desc:"开头悬念→中段反转→结尾种草，用故事力驱动转化",badges:[{t:"完播率 +35%",c:"exp"},{t:"高互动",c:"exp"}],tags:["娱乐化","故事型"],stat:"+35%",uses:"爆款剧情公式提炼",
    style_summary:"用mini剧情包裹产品信息，观众在享受故事的过程中自然被种草，完播率和互动率双高",personality:"会讲故事的创作者，善于设置悬念和反转",emotion_tone:"好奇→紧张→震惊→满足→种草",formula:"悬念开场→情节铺垫→关键反转→产品揭晓→情感收尾",hook_strategy:"用反转结果倒叙开头，'你绝对猜不到结局'",conflict_setup:"设置一个生活化的小矛盾或尴尬场景",trust_mechanism:"故事中自然展示产品效果，不强行推销",price_anchor:"在故事高潮后轻描淡写提及价格，'就这么个小东西'",urgency_tactic:"'故事里的XX链接在下方''同款在这里'",emotion_curve:"好奇(9)→铺垫(6)→反转(10)→种草(8)→行动(7)",pacing:"开头快切制造悬念→中段正常叙事→反转处停顿→结尾轻松",keyword_bank:["你猜怎么着","结局亮了","万万没想到","神反转","绝了","太离谱了"],power_words:["神反转","结局亮了","万万没想到","笑死"],sentence_patterns:["事情是这样的...（铺垫）","正当我以为XX的时候...【重】","万万没想到...（反转）","所以...（种草）"],sample_hooks:["闺蜜发现我偷用她的XX后...结局你猜不到","老板让我3天完成XX...我用了一个方法","相亲对象看到我素颜后的反应..."],dos:["反转要出人意料","故事要有代入感","产品植入要自然"],donts:["反转不要生硬","不要为了反转而反转","故事不要太长超过1分钟"]},
  // ═══ 行业专属模板 ═══
  {id:9,name:"美妆护肤种草",category:"行业专属",plat:"抖音",desc:"质地展示+使用过程+效果对比，美妆品类专属公式",badges:[{t:"完播率 +26%",c:"conv"},{t:"美妆专属",c:"exp"}],tags:["美妆","护肤","彩妆"],stat:"+26%",uses:"美妆品类专属",
    style_summary:"重视觉、重质感、重对比，用ASMR级的质地展示和前后对比制造种草冲动",personality:"精致的美妆爱好者",emotion_tone:"期待→满足→惊艳→种草",formula:"痛点/场景→质地展示→使用过程→效果对比→购买引导",hook_strategy:"用皮肤问题特写或质地ASMR开头",conflict_setup:"展示使用前的皮肤状态",trust_mechanism:"真实上脸展示+光线下质感+持妆测试",price_anchor:"对标大牌同成分产品价格",urgency_tactic:"'应季必备''换季必囤''用完必回购'",emotion_curve:"期待(7)→沉浸(9)→惊艳(10)→种草(9)→行动(8)",pacing:"质地展示慢镜头→上脸过程适中→效果对比快切",keyword_bank:["质地","上脸","持妆","不卡粉","奶油肌","水光感","成膜","吸收"],power_words:["奶油肌","水光肌","素颜神器","持妆12小时","零毛孔"],sentence_patterns:["看这个质地...【重】绝了！","上脸的感觉...一整个XX住！","持妆XX小时后...你看这效果","姐妹们...这个必须囤"],sample_hooks:["这个质地我能玩一整天...","上脸3秒就知道它不一般","持妆12小时实测...结果让我震惊"],dos:["质地展示要有ASMR感","光线要好突出质感","对比要在相同光线下"],donts:["不要用滤镜造假","不要跳过使用过程","效果不要过度PS"]},
  {id:10,name:"食品饮品诱惑力",category:"行业专属",plat:"抖音",desc:"食欲画面+制作过程+品尝反应，食品品类专属公式",badges:[{t:"完播率 +32%",c:"exp"},{t:"食品专属",c:"exp"}],tags:["食品","饮品","零食"],stat:"+32%",uses:"食品品类专属",
    style_summary:"用极致的食物画面调动食欲，制作过程的ASMR感和品尝时的真实反应是核心卖点",personality:"会吃懂吃的美食达人",emotion_tone:"好奇→食欲→满足→馋→下单",formula:"诱人画面→食材展示→制作/开箱→品尝反应→购买引导",hook_strategy:"用最诱人的食物特写开头，如拉丝、切开、汤汁流出",conflict_setup:"'好吃但买不到''排队3小时才能吃到'",trust_mechanism:"真实品尝反应+食材溯源+配料表展示",price_anchor:"'一杯奶茶钱''平均每顿才XX块'",urgency_tactic:"'应季限定''限量生产''卖完就没了'",emotion_curve:"食欲(9)→好奇(7)→满足(10)→馋(10)→行动(9)",pacing:"开头慢镜头食物特写→中段适中→品尝处停顿表情→结尾快",keyword_bank:["绝绝子","一整个爱住","停不下来","回购无数次","从小吃到大","妈妈的味道"],power_words:["爆浆","拉丝","入口即化","回味无穷","停不下来"],sentence_patterns:["你看这个XX...（慢镜头展示）","一口下去...【重】（表情反应）","根本停不下来...已经吃了XX个了","链接在下方...手慢无"],sample_hooks:["（芝士拉丝的慢镜头特写）","（刀切开食物，汁水流出的瞬间）","排队3小时才买到的XX...值不值？"],dos:["食物画面要极致诱人","品尝反应要真实","光线要暖突出食欲"],donts:["不要用冷色调","品尝反应不要夸张做作","不要忽略食品安全信息"]},
  {id:11,name:"3C数码开箱流",category:"行业专属",plat:"抖音",desc:"开箱仪式感+上手体验+对比测试，数码品类专属公式",badges:[{t:"完播率 +20%",c:"conv"},{t:"3C专属",c:"auth"}],tags:["数码","手机","电脑"],stat:"+20%",uses:"数码品类专属",
    style_summary:"开箱的仪式感+第一眼惊艳+上手实测+和竞品对比，理性中带惊喜",personality:"理性但有热情的数码爱好者",emotion_tone:"期待→惊艳→专注→认可→种草",formula:"开箱→第一印象→核心功能实测→对比竞品→总结推荐",hook_strategy:"用产品最惊艳的一个点开头，如'这个XX你见过吗？'",conflict_setup:"和上一代或竞品的差距对比",trust_mechanism:"实际使用场景+跑分数据+续航测试+拍照样张",price_anchor:"同价位横向对比，突出核心优势",urgency_tactic:"'首发价优惠''预售期限定''配件赠品限时'",emotion_curve:"期待(8)→惊艳(9)→专注(7)→认可(9)→行动(7)",pacing:"开箱处仪式感慢→上手适中→数据对比快切→总结适中",keyword_bank:["开箱","上手","实测","跑分","续航","质感","手感","性价比"],power_words:["质感拉满","性能怪兽","续航王者","真香","闭眼入"],sentence_patterns:["今天开箱的是...XX","拿到手第一感觉...质感XX","跑个分看看...【重】XX分！","这个价位...直接闭眼入"],sample_hooks:["XX最新款到了...这质感绝了","花了XX块买了5台手机做横评","这可能是今年最值得买的XX"],dos:["开箱要有仪式感","数据要真实可验证","优缺点都要说"],donts:["不要只说优点","不要用厂商宣传语","不要忽略实际体验"]},
];
const SCRIPTS=[
...
// TMPLLIB 统一引用 TEMPLATES（过滤掉"不使用模板"）
const TMPLLIB=TEMPLATES.filter(t=>!t.isNone);
    ...
    <div className="app">
      ...
      <div className="mn">
        ...
        {pg==="tmpl"&&<div className="sc">
          ...
          {tTab!=="AI提炼"&&<div className="fr"><div className="fg"><span className="fl">平台</span><div className="fcs">{["全部","抖音","小红书","视频号","通用"].map(f=><button key={f} className={`fc2 ${fp===f?"on":""}`} onClick={()=>setFp(f)}>{f}</button>)}</div></div></div>}
          {tTab!=="AI提炼"&&<div className="tg2">{TMPLLIB.filter(t=>{
            // 按标签页分类过滤
            if(t.category&&t.category!==tTab)return false;
            // 按平台过滤
            if(fp!=="全部"&&t.plat!==fp)return false;
            return true;
          }).map(t=><div className="tc" key={t.id}><div className="tc-tp"><span>{t.plat}</span><span>{t.uses||""}</span></div><div className="tc-n">{t.name}</div><div className="tc-d">{t.desc}</div><div className="tc-tgs">{(t.tags||[]).map((tg,i)=><span key={i} className="tc-tg">{tg}</span>)}</div><div className="tc-bot"><span className="tc-st"><I.Fire/> 完播率 {t.stat||"+20%"}</span><button className="tc-bt" onClick={()=>openModal("quick",t)}>用此模板创建 →</button></div></div>)}</div>}
          {tTab==="AI提炼"&&<div>
